...
fetch(BREEDS_URL)
    ...
    .then(data => {
        ...
        option.value = breedsArray[i] // <option value = 'breed' whatever breed array is at that point
        option.innerText = breedsArray[i]
        select.appendChild(option) // appends each option to select dropdown
        }
    })
    ...
    const dogInfo = {
        ...
        assignAge(){
            this.age = Math.floor(Math.random()*16+1) /// adding one lets it have minimum value
